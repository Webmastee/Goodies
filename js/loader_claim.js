...
document.getElementById("claimButton").innerText = claimPageInfo.claimButtonText;


    // let claimbuttons = document.querySelectorAll(".claimButton");

    // for (let i =0; i<claimbuttons.length; i++){
    //   claimbuttons[i].innerText = claimPageInfo.claimButtonText;
    // }
...
//     for (let i =0; i<claimbuttons.length; i++){
//       claimbuttons[i].innerText = claimPageInfo.title;
//     }
